window.SITE_DATA={
  projects:{
    ota1:{
      kicker:"Academic project · Cadence Virtuoso",
      title:"Fully-Differential Current-Mirror OTA",
      copy:"A Cadence Virtuoso design study focused on transistor sizing and the relationship between gain, bandwidth, offset, common-mode range and settling."
    },
    ota2:{
      kicker:"Academic project · Cadence Virtuoso",
      title:"Two-Stage OTA with Miller Compensation",
      copy:"A two-stage OTA design covering biasing, compensation, transistor sizing, offset and verification against the target specifications."
    },
    adb:{
      kicker:"Internship · Infineon Technologies",
      title:"Adaptive Driving Beam System Evaluation",
      copy:"Evaluation of an automotive Adaptive Driving Beam system, including the SEPIC-based LED regulator, dynamic measurements and protection trade-offs."
    }
  },
  profile:{
  ...
  books:[
    {
      id:"book-01", number:"01", title:"The Art of Electronics",
      author:"Paul Horowitz & Winfield Hill", year:"REFERENCE",
      description:"A practical circuit-level reference covering analogue electronics, devices, amplifiers, interfaces and measurement.",
      cover:"THE ART\nOF\nELECTRONICS", coverClass:"book-cover-a",
      link:"https://artofelectronics.net/"
    },
    {
      id:"book-02", number:"02", title:"Digital Design and Computer Architecture",
      author:"David Money Harris & Sarah L. Harris", year:"REFERENCE",
      description:"A digital design reference connecting logic, datapaths, processors, hardware description languages and computer architecture.",
      cover:"DIGITAL DESIGN\n& COMPUTER\nARCHITECTURE", coverClass:"book-cover-b",
      link:"https://www.elsevier.com/books/digital-design-and-computer-architecture/harris/978-0-12-394424-5"
    },
    {
      id:"book-03", number:"03", title:"Add another book",
      author:"Author / edition", year:"TO ADD",
      description:"Use this slot for the next book you want to keep in the collection.",
      cover:"YOUR NEXT\nBOOK", coverClass:"book-cover-c",
      link:"#"
    },
    {
      id:"book-04", number:"04", title:"Another book",
      author:"Author / edition", year:"TO ADD",
      description:"A further placeholder for your reading archive.",
      cover:"ANOTHER\nBOOK", coverClass:"book-cover-d",
      link:"#"
    }
  ]
};