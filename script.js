(function(){
  ...
  var positions = [{x:0,y:-24,r:-2,s:1.08},{x:50,y:14,r:5,s:0.97},{x:0,y:48,r:-4,s:0.95},{x:-50,y:14,r:4,s:0.97}];
  ...
  function renderCluster(){
    ...
    setTimeout(function(){
      ...
      grp.indices.forEach(function(flatIdx, pos){
        var p = positions[pos] || positions[positions.length - 1];
        ...
        el.style.transform = 'translate(-50%,-50%) translate(' + p.x + 'px,' + p.y + 'px) rotate(' + p.r + 'deg) scale(' + p.s + ')';
  ...
  function openDetail(i){
    ...
    var d = document.getElementById('vinyl-detail');
    d.hidden = false;
    fillDetail();
    var pop = document.getElementById('vinyl-disc-pop');
